...
// Extend the `threeGlobe` to be used within `react-three/fiber`
extend({ ThreeGlobe });
...
const Globe = ({ globeConfig, data }) => {
  ...
  const defaultProps = {
    pointSize: 1,
    atmosphereColor: "#F00", // Light turquoise for atmosphere
    showAtmosphere: true,
    atmosphereAltitude: 0.1,
    polygonColor: "#F00", // Turquoise polygon color
    globeColor: "#b2ebf2", // Light turquoise globe color
    emissive: "#F00", //red emissive 
...
export const WebGLRendererConfig = () => {
  ...
  useEffect(() => {
    ...
    gl.setClearColor(0xffffff, 0); // Light background color
  }, []);
...
export const World = (props) => {
  ...
  scene.fog = new Fog(0xe0f7fa, 400, 2000); // Light turquoise fog color
  return (
